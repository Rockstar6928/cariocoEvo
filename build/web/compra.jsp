<%-- 
    Document   : compra
    Created on : 27/08/2021, 03:25:29 PM
    Author     : jorge
--%>
    ...
    <body>
                    ...
                    <div class="col">
                        ...
                        <form id="procesar-pago" action="#" method="post">  
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-md-10">
                                    <input type="email" class="form-control" id="correo" placeholder="Ingresa tu correo" name="cc_to">
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-between">
                                <div class="col-md-4 mb-2">
                                    <a href="carrito.jsp" class="btn btn-info btn-block">Seguir comprando</a>
                                </div>
                                <div class="col-xs-12 col-md-4">
                                    <button href="#" class="btn btn-success btn-block" id="procesar-compra" disabled>Realizar compra</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#cliente' && '#correo').on('input change', function () {
                    if ($(this).val() != '') {
                        $('#procesar-compra').prop('disabled', false);
                    } else {
                        $('#procesar-compra').prop('disabled', true);
                    }
                });
            });
        </script>
